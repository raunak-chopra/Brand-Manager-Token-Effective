...
tools: local reads and browsing only when source verification is required
---
...
| Agent | Analytical structure, extended analogies, cautious qualifications | None (uses straight quotes, no tracking) |
...
- [model-fingerprints.md](reference/model-fingerprints.md) - GPT, Agent, Gemini, Grok, Perplexity specific tells
