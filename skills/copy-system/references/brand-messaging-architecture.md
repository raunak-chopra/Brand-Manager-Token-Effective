...
> For detailed examples, load `brand-messaging-architecture-examples.md` when the user needs them or to confirm usage.
...
Based on B2B message tests. Each layer must be addressed in order:
...
**The Drill Example:**
- People hire a drill to make a hole, to hang a picture, to feel at home (functional → emotional cascade).
...
4. Map each attribute to the value it enables.
5. Identify who cares most about that value.
6. Determine the market category that makes your value obvious.
7. Optionally, layer on a relevant market trend.
8. Create your positioning statement.
9. Share with team and get buy-in.
10. Translate into messaging.
...
4. **Introduce Features as "Magic Gifts"** — Capabilities that help reach the promised land.
5. **Name the Enemy** — An old mindset that has become a road to ruin.

*(See examples archive for full traditional vs. strategic narrative comparisons.)*
...
*(See examples archive for detailed Yoda/Luke concept breakdown.)*
...
**For each messaging pillar, combine:**
...
- **The "So What?" Test**: Ask "so what?" after each statement to ensure relevance.
- **The "Only" Test (Marty Neumeier)**: *Our [offering] is the only [category] that [benefit].*
...
> **The Say-Do Gap Warning**: Test willingness to pay through behavior, not stated intent.
...
> **Note:** For examples and templates, see skills/.../references/brand-messaging-architecture-examples.md or the 	emplates/ directory.
