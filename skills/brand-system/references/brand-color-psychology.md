...
> For detailed examples, load `brand-color-psychology-examples.md` when the user needs them or to confirm usage.
...
For detailed templates and audit worksheets, load `brand-color-psychology-examples.md`:
