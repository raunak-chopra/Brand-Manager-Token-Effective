...
> For detailed examples, load `brand-typography-systems-examples.md` when the user needs them or to confirm usage.
...
> "Typography exists to honor content." â€” Robert Bringhurst, *The Elements of Typographic Style*

> "Typography and design should enhance communication, not just look attractive." â€” Erik Spiekermann

> "I can teach anyone good typography in two or three days. The craft is very simple, the rest is just practice." â€” Erik Spiekermann

---

## Key Principles

1. **Start with personality** â€” Typography selection flows FROM brand personality TO typeface choices. Never the reverse.
2. **Honor content** â€” Beautiful type that doesn't serve content fails its purpose.
3. **Contrast through classification** â€” Serif + sans-serif pairing creates natural hierarchy without conflict.
4. **Form follows function** â€” Body text prioritizes legibility; display text can prioritize personality.
5. **Consistency builds recognition** â€” Every touchpoint reinforces (or undermines) brand perception.
6. **Accessibility is non-negotiable** â€” Design for the widest possible audience.
7. **Systems scale** â€” Create hierarchies that work across all applications and contexts.
...
**Key Insight**: "If the brand can define itself using descriptions to capture the tone, personality, and principlesâ€”we can translate that into typographic forms."
...
4. **Apply to Hierarchy**: Map calculated sizes to H1â€“H6, body, captions
...
1. **Seek Contrast, Not Conflict**
   > "When two styles are paired that are almost the sameâ€”but not quiteâ€”they begin to clash, like wearing two slightly different plaid patterns at once." â€” Ellen Lupton
...
4. **Limit Strong Personalities**: Mixing two bold typographic personalities rarely worksâ€”they compete for attention.
...
**FOIT vs FOUT**:
- **FOIT (Flash of Invisible Text)**: Browser hides text until font loadsâ€”poor UX
- **FOUT (Flash of Unstyled Text)**: Shows fallback font first, swaps when readyâ€”preferred
...
**Accessibility is Non-Negotiable**: Design for the widest possible audienceâ€”good accessibility is good design.

**Start With Personality**: Typography selection flows FROM brand personality TO typeface choices. Never the reverse.

**If You Have Fewer Choices**: "It doesn't necessarily make your life more difficult. It often makes it easier." â€” Erik Spiekermann

---


> **Note:** For examples and templates, see skills/.../references/brand-typography-systems-examples.md or the 	emplates/ directory.
