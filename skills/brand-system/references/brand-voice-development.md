...
> "You have the same voice all the time, but your tone changes. You might use one tone when you're out to dinner with your closest friends, and a different tone when you're in a meeting with your boss." â€” Mailchimp Content Style Guide
...
**Analogy**: You have the same voice whether talking to your boss or your friends â€” but your tone changes.
...
**Key Principle**: Balance user needs with brand identity â€” being exclusively user-focused leads to bland sameness.
...
|-----------|----------|---------|
| **Formality** | Formal â†â†’ Casual | "We appreciate your inquiry" vs "Hey, good question!" |
| **Humor** | Serious â†â†’ Funny | Straightforward vs witty |
| **Reverence** | Respectful â†â†’ Irreverent | Traditional vs rule-breaking |
| **Energy** | Matter-of-fact â†â†’ Enthusiastic | Neutral vs excited |

**Application**:
- Plot intended position on each dimension
- A brand CAN be serious AND casual (like a friendly financial advisor)
- Avoid landing exactly in the middle on all dimensions â€” that's generic
...
1. **Be clear and simple** â€” Aim for comprehension
2. **Anticipate (and answer!) the readers' questions** â€” Be relevant
3. **Be intentionally playful and bold** â€” Delight without distracting
4. **Build appropriate emotional connection** â€” Be generous with warmth
...
| # | Mistake | Pattern | Fix |
|---|---------|---------|-----|
| 1 | **Being Generic** | "Innovative, customer-focused, passionate" | Use the "airport test" â€” recognizable without logo? |
...
Place brand on spectrums: Conservative â†â†’ Extravagant, Fun â†â†’ Serious, Traditional â†â†’ Modern.
...
> **Note:** For examples and templates, see skills/.../references/brand-voice-development-examples.md or the 	emplates/ directory.
