...
> For detailed examples, load `brand-values-development-examples.md` when the user needs them or to confirm usage.
...
**Warning**: Don't confuse aspirational goals with core values.
...
3. **The Five Whys** (Denise Lee Yohn): Start with a product/service → ask "why is it important?" → "why does that matter?" × 5
...
Ask the team: "We always..." / "We never..." — these reveal actual behaviors.
...
> **Note:** For examples and templates, see skills/.../references/brand-values-development-examples.md or the 	emplates/ directory.
