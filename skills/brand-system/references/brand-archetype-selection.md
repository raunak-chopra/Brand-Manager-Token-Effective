...
> For detailed examples, load `brand-archetype-selection-examples.md` when the user needs them or to confirm usage.
...
For detailed templates and selection worksheets, load `brand-archetype-selection-examples.md`:
