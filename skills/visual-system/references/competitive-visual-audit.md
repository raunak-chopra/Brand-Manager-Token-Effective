...
> "When others zig, zag. Radical differentiation is the surest path to relevance." â€” Marty Neumeier
...
Plot brands on two axes â€” "Good" (customer value) and "Different" (novelty/surprise):

```
                DIFFERENT (Novel, Surprising)
                       â”‚
      ZONE OF          â”‚         ZONE OF
      IRRELEVANCE      â”‚         DOMINANCE
      (Different but   â”‚         (Good AND Different)
       not good)       â”‚         â† THE GOAL
                       â”‚
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                       â”‚
      ZONE OF          â”‚         ZONE OF
      MEDIOCRITY       â”‚         COMMODITIZATION
      (Neither good    â”‚         (Good but
       nor different)  â”‚          not different)
                       â”‚
                GOOD (Customer Value)
```
...
1. **Choose Two Axes** that matter to customers and create contrast:
   - Price (Low â†’ High) vs. Quality (Low â†’ High)
   - Professional â†” Friendly
   - Traditional â†” Innovative
   - For Experts â†” For Everyone

2. **Plot 10+ competitors** on the map

3. **Identify White Space** â€” quadrants with low competition
...
**Typography Trends**
- All serif? â†’ Consider sans-serif
- All geometric sans? â†’ Consider humanist or serif

**Imagery Patterns**
- All stock photography? â†’ Consider custom illustration
- All people shots? â†’ Consider product/abstract
...
1. **Map before you create** â€” Understand the landscape before making visual decisions
2. **White space is opportunity** â€” What no one does is what you could own
3. **Color is fastest differentiator** â€” Start there for visual differentiation
4. **Distinctiveness requires consistency** â€” Different only works if you maintain it
5. **Be the Only, not the Best** â€” Neumeier's core principle
...
> **Note:** For examples and templates, see skills/.../references/competitive-visual-audit-examples.md or the 	emplates/ directory.
