...
| Big ideas, creative territories, campaign concepts, brand worlds, concept boards, generated image concepts, creative critique | `creative-director` | `creative-system` | References: creative territories, big idea frameworks, concept board standards, agency image generation, creative quality rubric.<br>Workflows: develop territories, generate big ideas, build concept board, produce image concepts, critique and improve. |
...
- Idea routes, concept boards, stakeholder review, and generated visual concepts: `skills/creative-system/`
...
- If the user asks for "more creative," "award-winning," "mesmerising," "big ideas," "viral," "bold," "unforgettable," "agency-level," creative routes, or concept boards, use `creative-director` + `creative-system`.
