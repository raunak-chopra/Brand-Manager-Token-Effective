...
| Optimization | Performance review, budget changes, or test cadence. | `paid-media-playbook.md`; use `conversion-system` for attribution depth. |
| Creative Requirements | Angles, formats, copy needs, visual briefs. | `ad-copy-templates.md`; use `ad-creative` for bulk variants. |
| Diagnostics | Wasted spend audit, CPA spike diagnosis, creative fatigue check, overlap detection, impression share analysis, or account health check. | Platform-specific reference: `google-ads.md` or `meta-ads.md`. |
| Reporting | Weekly digest, creative scorecard, audience insights, ROAS breakdown, competitor analysis, or campaign health dashboard. | `reporting-templates.md`. |

> **Boundary**: `paid-media-playbook.md` covers cross-platform strategy, structure, budgets, and bidding. Platform reference files (`google-ads.md`, `meta-ads.md`) cover platform-specific diagnostic procedures and optimization actions. `reporting-templates.md` covers report formats. Avoid loading both the playbook and a platform file unless the task explicitly spans strategy and diagnostics.
